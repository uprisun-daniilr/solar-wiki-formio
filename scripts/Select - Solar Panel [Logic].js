...
const warranty = findDeep(
  value,
  "properties.Warranty Specifications.Output Warranty Term.value"
);
warrantyField.setValue(warranty);

const capacity = findDeep(
  value,
  "properties.PV Product Performance.Rated Power.value"
);
...
const link = `${DOMAIN}/info?solution_id=${value.id}&solution_type=panel`;
